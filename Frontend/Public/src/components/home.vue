<template>
			<main role="main" class="inner cover text-center">
				<div class="container-fluid videos">
					<div class="row">
						<!--<div class="video col-md-12 mb-5" style="padding: 0; margin: 0;z-index: 9999">
              <iframe width="100%" height="520px" src="https://www.youtube.com/embed/w_AGPkESs3s" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>-->

						<!-- VIDEO PRESENTATION -->
						<div class="col-md-9 bg-perso py-5">
							<div class="container-fluid">
								<div class="row">

									<div class="col-md-8" style="margin-bottom: 5px">
										<div class="bg-white first block " style="height: 206.455px;">
											<div class="img top">
												<img src="@/assets/img/citoyen.png" class="border-r" style="height:170px; width:100%;">
											</div>

											<div class="texts bottom">
												<div class="mr-auto ml-auto p-5 text-left block-element border-r" style="height: 206.455px; background-repeat: no-repeat; background-size:cover" :style="{ backgroundImage: 'url(' + require('./../assets/yellow.jpg') + ')' }">
													<strong class="text-white"><h1>ESPACE CITOYEN</h1></strong>
													<small class="text-white lead">Retrouver toutes les informations a propos des services de la communes</small>
													<br>
													<small class="text-white lead">les informations a propos des services de la mairies</small>
													<br><br>
												</div>
											</div>
										</div>
										...
										<a href="http://ngong.geocameroun.cm/#/">
											<div class="bg-white first block border-r" style="height: 206.455px;">
												<div class="img container" style="height:206.455px; width:100%; max-width: 100%">
													<img src="@/assets/img/geocommunals.png" alt="" class="" style="margin-top: 8%; height: 150px; width:60%;">
													<div class="bottom-right"><h5 class="font-weight-bold text-dark" style="margin: auto">GEOCOMMUNAL</h5></div>
												</div>
									...
									<div class="col-md-4" style="margin-bottom: 5px">
										<router-link to="/calendar">
											<div class="bg-white block first border-r" style="height: 206.455px;">
												<div class="img container" style="height:206.455px; width:100%; max-width: 100%">
													<img src="@/assets/img/undraw_booking_33fn.svg" alt="" style="height: 170px; width:100%">
													<div class="top-left"><h5 class="font-weight-bold text-dark">ACTIVITIES</h5></div>
												</div>
										...
										<a href="http://kolibridemo.learningequality.org/en/learn/#/topics">
											<div class="bg-white block first border-r" style="height: 206.455px;">
												...
												<div class="texts block-element p-5 text-left" style="height: 206.455px; background-repeat: no-repeat; background-size:cover" :style="{ backgroundImage: 'url(' + require('./../assets/red.png') + ')' }">
													<strong class="text-white"><h1>J'APPRENDS ET J'AVANCE</h1></strong>
													<small class="text-white lead">Retrouver une liste de lecon et de jeux éducatifs</small>
													<br>
													<small class="text-white lead">Une section spéciallement dédié a apprendre</small>
													<br><br>
												</div>
											</div>
										</a>
									...
									<div class="col-md-8" style="margin-bottom: 5px">
										<router-link to="/library-index">
											<div class="bg-white block first border-r"style="height: 206.455px;">
												...
												<div class="texts block-element p-5 text-left" style="height: 206.455px; background-repeat: no-repeat; background-size:cover" :style="{ backgroundImage: 'url(' + require('./../assets/red.png') + ')' }">
													<strong class="text-white"><h1>DOCUMENTS ET LIVRES UTILES</h1></strong>
													<small class="text-white lead">Retrouver une liste de livre et épreuves d'examens officiels</small>
													<br>
													<small class="text-white lead">Une section spéciallement dédié à l'éducation dans tous les domaines</small>
													<br><br>
									...
									<div class="col-md-4" style="margin-bottom: 5px">
										<div class="bg-white block first border-r" style="height: 206.455px;">
											...
											<div class="texts block-element text-left p-5 bg-info" style="height: 206.455px; background-repeat: no-repeat; background-size:cover" :style="{ backgroundImage: 'url(' + require('./../assets/bg.png') + ')' }">
												<strong class="text-white"><h1>JEUX</h1></strong>
												<small class="text-white lead">Retrouver une liste de jeux éducatifs</small>
												<br>
												<small class="text-white lead">Une section dédié au divertissement</small>
												<br><br>
										...
										<router-link to="/announcement">
											<div class="bg-white block first border-r" style="height: 206.455px;">
												...
												<div class="texts block-element p-5 text-left bg-success" style="height: 206.455px; background-repeat: no-repeat; background-size:cover" :style="{ backgroundImage: 'url(' + require('./../assets/bg.png') + ')' }">
													<strong class="text-white"><h1>TOUS SAVOIR SUR LA COMMUNAUTÉ</h1></strong>
													<small class="text-white lead">Retrouver toutes les informations au sujet de la communauté</small>
													<br>
													<small class="text-white lead">Une section spéciallement dédié a apprendre</small>
													<br><br>
									...
									<div class="col-md-6" style="margin-bottom: 5px">
										...
										<div class="bg-white first block border-r" style="height: 206.455px; ">
											...
											<div class="texts block-element p-5 text-left" style="height: 206.455px; background-repeat: no-repeat; background-size:cover" :style="{ backgroundImage: 'url(' + require('./../assets/yellow.jpg') + ')' }">
												<strong class="text-white"><h1>NOTRE MARCHÉ</h1></strong>
												<small class="text-white lead">Retrouver une liste de lecon et de jeux éducatifs</small>
												<br>
												<small class="text-white lead">Une section spéciallement dédié a apprendre</small>
												<br><br>
									...
									<div class="col-md-6" style="margin-bottom: 5px">
										<router-link to="/communication">
											<div class="bg-white block first border-r" style="height: 206.455px;">
												<div class="img container" style="height: 206.455px; width:100%; max-width: 100%">
													<img src="@/assets/img/undraw_chatting_2yvo.svg" alt="" style="height: 170px; width:100%; max-width: 100%">
													<div class="bottom-right"><h5 class="font-weight-bold text-dark">COMMUNICATION</h5></div>
												</div>

												<div class="texts block-element p-5 text-left bg-success" style="height: 206.455px; background-repeat: no-repeat; background-size:cover" :style="{ backgroundImage: 'url(' + require('./../assets/red.png') + ')' }">
													<strong class="text-white"><h1>COMMUNICATION</h1></strong>
													<small class="text-white lead">Service de messagerie gratuite</small>
													<br>
													<small class="text-white lead">En un click retrouvez-vous</small>
													<br><br>
									...
									<div class="col-md-6" style="margin-bottom: 5px">
										<router-link to="/communication">
											<div class="bg-white block first border-r" style="height: 206.455px;">
												<div class="img container" style="height: 206.455px; width:100%; max-width: 100%">
													<img src="@/assets/img/undraw_chatting_2yvo.svg" alt="" style="height: 170px; width:100%; max-width: 100%">
													<div class="top-left"><h5 class="font-weight-bold text-dark">MESSAGERIE COMMUNAUTAIRE</h5></div>
												</div>

												<div class="texts block-element p-5 text-left bg-success" style="height: 206.455px; background-repeat: no-repeat; background-size:cover" :style="{ backgroundImage: 'url(' + require('./../assets/bg.png') + ')' }">
													<strong class="text-white"><h1>MESSAGERIE COMMUNAUTAIRE</h1></strong>
													<small class="text-white lead">Service de messagerie gratuite</small>
													<br>
													<small class="text-white lead">En un click retrouvez-vous</small>
													<br><br>
						...
						<!-- SIDEBAR  -->
						<div class="col-md-3 bg-perso py-5">
							<div class="sidebar">
								<div class="container-fluid">
									<div class="row">
...
import backgroundUrl from '@/assets/yellow.jpg'
</script>
