...
export default {
    ...
    created() {
        axios.get('http://localhost:8000/community/library/epreuves/index').then((response)=>{
    ...
    methods: {
        getId:function(event){
            axios.get('http://localhost:8000/community/library/examen/show/' + event.target.id).then((response)=>{
