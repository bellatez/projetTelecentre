...
export default {
    ...
    created() {
        axios.get('http://164.132.99.169:8000/community/library/epreuves/index').then((response)=>{
    ...
    methods: {
        getId:function(event){
            axios.get('http://164.132.99.169:8000/community/library/examen/show/' + event.target.id).then((response)=>{
