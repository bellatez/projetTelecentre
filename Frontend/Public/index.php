...
<header>
    <nav class="navbar navbar-expand-md bg-white text-dark fixed-top">
        <a id="lien" class="navbar-brand text-dark disabled" href="#"><img src="css/image/icon.png" style="height: 32px; width: 32px"> CMCC <small class="mb-5">Cameroon Mesh Community Center</small></a>
...
<footer class="text-muted py-5">
    <div class="container" style="display: flex; flex-direction:row">
        ...
        <div class="footer-text text-rigth" style="display: flex; flex-direction:column">
            <p>Vos commentaires et avis seront un plus au travail a fournir afin de vous satisfaire</p>
            <p>Besoin d'aide ? <a href="https://getbootstrap.com/">Visite notre zone de question réponse</a> <a href="/docs/4.3/getting-started/introduction/"> </a>.</p>
        </div>
    </div>
</footer>
...
<script src="https://kit.fontawesome.com/b06f9a5158.js" crossorigin="anonymous"></script>
<script>
    $('#next').click(function () {
